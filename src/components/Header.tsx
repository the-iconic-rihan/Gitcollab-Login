...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-white h-20 headerDiv">
        <nav className="h-full flex justify-between container items-center">
          <div>
            <Link to="/" className="text-ct-dark-600 text-2xl font-semibold">
              <img
                src={gitcollab1}
                className="header-logo d-block " style={{width:"100%",height:"50px"}}
                alt="logo"
              />{" "}
            </Link>
          </div>
          <ul className="flex items-center gap-4">
            <li>
              <Link to="/" className="text-ct-dark-800 font-black">
                Home
              </Link>
            </li>
            {!user && (
              <>
                <li>
                  <Link to="/login" className="text-ct-dark-800 font-black">
                    Login
                  </Link>
                </li>
                {/* <li>
